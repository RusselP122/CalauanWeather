...
if __name__ == "__main__":
    ...
    enc_file = "public/data/aifs_tc_latest.enc"
    ...
    title_5day = f"ECMWF AIFS 5-Day Forecast Tropical Cyclone Tracks\nWestern Pacific ({forecast_start} to {end_5day})"
    ...
    title_long = f"ECMWF AIFS {long_plot_days}-Day Forecast Tropical Cyclone Tracks\nWestern Pacific ({forecast_start} to {end_long})"
    out_long = f"public/assets/aifs_tropical_cyclone_15day_forecast_{init_time_str}.png"
