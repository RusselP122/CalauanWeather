...
if __name__ == "__main__":
    ...
    enc_file = "public/data/aigefs_tc_latest.enc"
    ...
    title_5day = f"NOAA AI-GEFS 5-Day Forecast Tropical Cyclone Tracks\nWestern Pacific ({forecast_start} to {end_5day})"
    ...
    title_15day = f"NOAA AI-GEFS 15-Day Forecast Tropical Cyclone Tracks\nWestern Pacific ({forecast_start} to {end_15day})"
