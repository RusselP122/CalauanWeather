...
const LOCAL_CSV = {
    ...
    aigefs: "/data/aigefs_tc_latest.enc",
};
...
export default function SpaghettiPlot() {
    ...
    useEffect(() => {
        ...
        const loadAllCycles = async () => {
            ...
            try {
                ...
                const activeCycles = dataset === "large" ? manifest.large : (dataset === "fnv3p2" ? manifest.base : []);
    ...
    const exportScreenshot = async () => {
        ...
        try {
            ...
            ctx.strokeText("@ CalauanWeather", canvas.width - paddingX, canvas.height - paddingY);
            ctx.fillText("@ CalauanWeather", canvas.width - paddingX, canvas.height - paddingY);
